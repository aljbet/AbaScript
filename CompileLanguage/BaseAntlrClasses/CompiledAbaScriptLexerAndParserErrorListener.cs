...
namespace CompileLanguage.BaseAntlrClasses;

public class CompiledAbaScriptLexerAndParserErrorListener : IAntlrErrorListener<int>, IAntlrErrorListener<IToken>
{
